...
let audience=p.get('audience')||'common';
const guided=p.get('guided')==='1'&&audience!=='common';
const school=p.get('school')||'';
const source=p.get('source')||'';
const body=document.body;
body.dataset.audience=audience;
const labels={common:'Phiếu chung',public:'Dành cho trường mầm non công lập',private:'Dành cho trường mầm non tư thục',system:'Dành cho hệ thống trường'};
const titles={common:'Cho Sunbot biết bối cảnh của nhà trường.',public:'Một vài thông tin để Sunbot chuẩn bị phương án phù hợp với trường công lập.',private:'Một vài thông tin để Sunbot chuẩn bị phương án phù hợp với trường tư thục.',system:'Một vài thông tin để Sunbot chuẩn bị phương án phù hợp với hệ thống trường.'};
const leads={common:'Phiếu này chỉ hỏi những thông tin cần thiết để chuẩn bị buổi trao đổi tiếp theo.',public:'Phiếu tập trung vào giáo viên, điểm trường, điều kiện tổ chức và nguồn lực triển khai. Không mặc định nhà trường phải tổ chức lớp thu phí.',private:'Phiếu tập trung vào giá trị giáo dục, phụ huynh, tuyển sinh, năng lực giáo viên và hiệu quả đầu tư.',system:'Phiếu tập trung vào chuẩn hóa nhiều cơ sở, quyền sử dụng, đào tạo, thiết bị, kiểm soát chất lượng và dữ liệu.'};
